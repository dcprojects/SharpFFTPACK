...
{
    /// <summary>
    /// Routines for FFT transform of a real periodic sequence.
    /// </summary>
    public class RealDoubleFFT_Mixed
    {
        /// <summary>
        /// Real FFT's forward processing of factor 2.
        /// </summary>
        private void radf2(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
            int i, k, ic;
            double ti2, tr2;
        ...
        /// <summary>
        /// Real FFT's backward processing of factor 2.
        /// </summary>
        ...
        private void radb2(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
            int i, k, ic;
            double ti2, tr2;
        ...
        /// <summary>
        /// Real FFT's forward processing of factor 3.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="l1"></param>
        /// <param name="cc"></param>
        ...
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        private void radf3(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
            const double taur = -0.5D;
            const double taui = 0.86602540378443864676372317075293618347140262690519031402790348975; // Math.Sqrt(3) / 2DD
        ...
        /// <summary>
        /// Real FFT's backward processing of factor 3.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="l1"></param>
        /// <param name="cc"></param>
        ...
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        private void radb3(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
            const double taur = -0.5D;
            const double taui = 0.86602540378443864676372317075293618347140262690519031402790348975; // Math.Sqrt(3) / 2DD
        ...
        /// <summary>
        /// Real FFT's forward processing of factor 4.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="l1"></param>
        /// <param name="cc"></param>
        ...
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        private void radf4(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
            const double hsqt2 = 0.70710678118654752440084436210484903928483593768847403658833986900; // Math.Sqrt(2) / 2D
        ...
        /// <summary>
        /// Real FFT's backward processing of factor 4.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="l1"></param>
        /// <param name="cc"></param>
        ...
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        private void radb4(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
        ...
        /// <summary>
        /// Real FFT's forward processing of factor 5.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="l1"></param>
        /// <param name="cc"></param>
        ...
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        private void radf5(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
            ...
            int i, k, ic;
            double
                ci2, di2, ci4, ci5, di3, di4, di5, ci3, cr2, cr3, dr2, dr3,
        ...
        /// <summary>
        /// Real FFT's backward processing of factor 5.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="l1"></param>
        /// <param name="cc"></param>
        ...
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        private void radb5(int ido, int l1, double[] cc, double[] ch, double[] wtable, int offset)
        {
            const double tr11 = 0.30901699437494742410229341718281905886015458990288143106772431137; // Math.Cos(2 * Math.PI / 5D
            const double ti11 = 0.95105651629515357211643933337938214340569863412575022244730564442; // Math.Sin(2 * Math.PI / 5D)
            const double tr12 = -0.80901699437494742410229341718281905886015458990288143106772431135; // Math.Cos(4 * Math.PI / 5D)
        ...
        /// <summary>
        /// Real FFT's forward processing of general factor.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="ip"></param>
        /// <param name="l1"></param>
        /// <param name="idl1"></param>
        /// <param name="cc"></param>
        /// <param name="c1"></param>
        /// <param name="c2"></param>
        /// <param name="ch"></param>
                   ...
                   double[] wtable, int offset)
        {
            ...
            int idij, ipph, i, j, k, l, j2, ic, jc, lc, ik, it, nbd;
        ...
        /// <summary>
        /// Real FFT's backward processing of general factor.
        /// </summary>
        /// <param name="ido"></param>
        /// <param name="ip"></param>
        /// <param name="l1"></param>
        ...
        private void radbg(int ido, int ip, int l1, int idl1, double[] cc, double[] c1,
                   double[] c2, double[] ch, double[] ch2, double[] wtable, int offset)
        {
            const double twopi = 2 * Math.PI;

            int     idij, ipph, i, j, k, l, j2, ic, jc, lc, ik, it;
        ...
        /// <summary>
        /// Further processing of Real forward FFT.
        /// </summary>
        /// <param name="n"></param>
        /// <param name="c"></param>
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        protected void rfftf1(int n, double[] c, double[] wtable, int offset)
        {
            int i;
        ...
        /// <summary>
        /// Further processing of Real backward FFT.
        /// </summary>
        /// <param name="n"></param>
        /// <param name="c"></param>
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        protected void rfftb1(int n, double[] c, double[] wtable, int offset)
        {
            int i;
        ...
        /// <param name="r"></param>
        /// <param name="wtable"></param>
        protected void rfftf(int n, double[] r, double[] wtable)
        {
            if (n == 1)
                return;
        ...
        /// <param name="r"></param>
        /// <param name="wtable"></param>
        protected void rfftb(int n, double[] r, double[] wtable)
        {
            if (n == 1)
                return;
        ...
        /// <summary>
        /// Further initialization of Real FFT.
        /// </summary>
        /// <param name="n"></param>
        /// <param name="wtable"></param>
        /// <param name="offset"></param>
        protected void rffti1(int n, double[] wtable, int offset)
        {
            const double twopi = 2 * Math.PI;
        ...
        /// </summary>
        /// <param name="n"></param>
        /// <param name="wtable">Wave table; length = 2 * n + 15</param>
        protected void rffti(int n, double[] wtable)
        {
            if (n == 1)
                return;
